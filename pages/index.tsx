...
const Home: NextPage = () => {
  ...
  const editionDrop = useContract("0x393CfceE30f519E634DA7E560110D7a07b7D1825", "edition-drop").contract;
  const token = useContract("0x393CfceE30f519E634DA7E560110D7a07b7D1825", "token").contract;
    // 投票コントラクトの初期化
