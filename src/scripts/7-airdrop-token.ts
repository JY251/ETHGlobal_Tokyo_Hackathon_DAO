...
const editionDrop = sdk.getContract("0x393CfceE30f519E634DA7E560110D7a07b7D1825", "edition-drop");

// ERC-20 トークンコントラクトのアドレス
const token = sdk.getContract("0x6556725D99e6af24a6ebc23d090225B9be5cad54", "token");
...
(async () => {
  try {
    ...
    console.log("walletAddress.length:", walletAddresses.length)
